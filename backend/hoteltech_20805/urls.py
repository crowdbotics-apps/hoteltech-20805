"""hoteltech_20805 URL Configuration
...
admin.site.site_header = "hoteltech"
admin.site.site_title = "hoteltech Admin Portal"
admin.site.index_title = "hoteltech Admin"

# swagger
api_info = openapi.Info(
    title="hoteltech API",
    default_version="v1",
    description="API documentation for hoteltech App",
)
